...
|
*/
defined('XERA_VERSION')        || define('XERA_VERSION', '1.2.8'); // build version
defined('XERA_TAG')            || define('XERA_TAG', 'Hollow'); // build tag
defined('XERA_DATE')        || define('XERA_DATE', '23-08-2022'); // build date
defined('XERA_AFFL')        || define('XERA_AFFL', 123456); // iFastNet affiliate id
...
|
*/
defined("HASH_ALGO_64")        || define('HASH_ALGO_64', 'sha256'); // 64 charatchers hashing algo
defined("HASH_ALGO_32")        || define('HASH_ALGO_32', 'haval128,3'); // 32 charatchers hashing algo
defined("HASH_ALGO_16")        || define('HASH_ALGO_16', 'fnv1a64'); // 16 charatchers hashing algo
defined("HASH_ALGO_8")        || define('HASH_ALGO_8', 'crc32'); // 8 charatchers hashing algo
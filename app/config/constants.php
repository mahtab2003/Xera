...
|
*/
defined('XERA_VERSION')		OR define('XERA_VERSION', '1.2.6'); // build version
defined('XERA_TAG')			OR define('XERA_TAG', 'Chocolate'); // build tag
defined('XERA_DATE')		OR define('XERA_DATE', '04-08-2022'); // build date

...
|
*/
defined('XERA_VERSION')		OR define('XERA_VERSION', '1.2.7'); // build version
defined('XERA_TAG')			OR define('XERA_TAG', 'Vanilla'); // build tag
defined('XERA_DATE')		OR define('XERA_DATE', '13-08-2022'); // build date

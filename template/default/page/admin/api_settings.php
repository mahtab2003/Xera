		...
		<ul class="nav nav-tabs nav-fill">
			<li class="nav-item">
				<a href="#general" class="nav-link <?php if (empty($_GET)): ?>
					active
				<?php endif ?>" data-bs-toggle="tab"><i class="fa fa-cogs me-2"></i>General</a>
			</li>
			<li class="nav-item">
				<a href="#mofh" class="nav-link <?php if ($this->input->get('mofh')): ?>
					active
				<?php endif ?>" data-bs-toggle="tab"><i class="fa fa-network-wired me-2"></i>MyOwnFreeHost</a>
			</li>
			<li class="nav-item">
				<a href="#smtp" class="nav-link <?php if ($this->input->get('smtp')): ?>
					active
				<?php endif ?>" data-bs-toggle="tab"><i class="fa fa-envelope me-2"></i>Simple Mailer</a>
			</li>
			<li class="nav-item">
				<a href="#captcha" class="nav-link <?php if ($this->input->get('captcha')): ?>
					active
				<?php endif ?>" data-bs-toggle="tab"><i class="fa fa-robot me-2"></i>Bot Protection</a>
			</li>
			<li class="nav-item">
				<a href="#ssl" class="nav-link <?php if ($this->input->get('ssl')): ?>
					active
				<?php endif ?>" data-bs-toggle="tab"><i class="fa fa-shield-alt me-2"></i>SSL Certificates</a>
			</li>
			<li class="nav-item">
				<a href="#sitepro" class="nav-link <?php if ($this->input->get('sitepro')): ?>
					active
				<?php endif ?>" data-bs-toggle="tab"><i class="fa fa-brush me-2"></i>Site Builder</a>
			</li>
			<li class="nav-item">
				<a href="#oauth" class="nav-link <?php if ($this->input->get('oauth')): ?>
					active
				<?php endif ?>" data-bs-toggle="tab"><i class="fab fa-github me-2"></i>Oauth2</a>
			</li>
		</ul>

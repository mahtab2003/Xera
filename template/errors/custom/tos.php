						...
						<div class="tabs pb-3">
						 ...
						 <div id="Terms" class="tab-content">
						 	<h2>1. ACCEPTANCE OF TERMS</h2>
									...
									</p><h2>5. MEMBER ACCOUNT, PASSWORD AND SECURITY</h2>
						 ...
						 <div id="Policy" class="tab-content">
							...
							<p>We only share your personal data as necessary for any third party to provide the services as requested or as needed on our behalf. These third parties (and any subcontractors) are subject to strict data processing terms and conditions and are prohibited from utilising, sharing or retaining your personal data for any purpose other than as they have been specifically contracted for (or without your consent). For further information on our sub-processors please refer to <b><a href="https://<?= base_url() ?>/ThirdPartyDataProcessors.pdf" target="_blank">our list of Third-Party Data Processors</a>.</b></p>
